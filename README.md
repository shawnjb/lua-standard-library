...
The documentation is generated by LDoc. You can view either the [algorithms documentation](https://shawnjb.github.io/docs/algorithms) or the [structures documentation](https://shawnjb.github.io/docs/structures).